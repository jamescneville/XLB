...
class MultiresIncompressibleNavierStokesStepper(Stepper):
    ...
    * **FUSION_AT_FINEST_SFV_ALL** — SFV / CFV splitting at all levels.
    ...
    def _construct_neon(self):
        ...
        # Per-voxel gating of multiresolution work is driven by the precomputed
        # `needs_mres` field used by the specialized CFV containers below.
        ...
        # Full CFV collision path: boundary conditions plus multiresolution accumulation.
        collide_cfv_finest = collide_bc_accum
